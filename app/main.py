...
from app.scraping import (filter_articles, get_request, make_soup,
                          scraping_developers, scraping_repositories)

app = fastapi.FastAPI()


DOMAIN_NAME = "https://demo-github-trending.moneymatch.technology:8443"
